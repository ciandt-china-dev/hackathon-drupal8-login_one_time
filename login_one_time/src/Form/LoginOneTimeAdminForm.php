...
class LoginOneTimeAdminForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['global']['login_one_time_expiry'] = array(
      '#type' => 'textfield',
      '#title' => t('Link expiry'),
      '#default_value' => $config->get('login_one_time_expiry'),
    ...
    $form['global']['login_one_time_user_widget'] = array(
      ...
      '#default_value' => $config->get('login_one_time_user_widget'),
      '#options' => array(
    ...
    $form['mail']['login_one_time_mail_message'] = array(
      '#markup' => t('Customize <em>login one time</em> e-mail messages sent to users at the <a href="!user_settings">User settings</a> page.', array('!user_settings' => Url::fromRoute('entity.user.admin_form')->toString())),
    );
    ...
    $form['path']['listed']['login_one_time_path_current'] = array(
      ...
      '#default_value' => $config->get('login_one_time_path_current'),
    );
    $form['path']['listed']['login_one_time_path_custom'] = array(
      '#type' => 'textarea',
      '#title' => t('Custom paths'),
      '#default_value' => $config->get('login_one_time_path_custom'),
    ...
    $form['user']['login_one_time_user_view'] = array(
      ...
      '#default_value' => $config->get('login_one_time_user_view'),
    );
    $form['user']['login_one_time_user_select'] = array(
      ...
      '#default_value' => $config->get('login_one_time_user_select'),
    );
    $form['user']['login_one_time_user_set_mail'] = array(
      ...
      '#default_value' => $config->get('login_one_time_user_set_mail'),
    );
    $form['user']['login_one_time_user_ignore_current_pass'] = array(
      ...
      '#default_value' => $config->get('login_one_time_user_ignore_current_pass'),
    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config
      ...
      ->set('login_one_time_path_user', $form_state->getValue('login_one_time_path_user'))
      ->set('login_one_time_path_user_edit', $form_state->getValue('login_one_time_path_user_edit'))
      ->set('login_one_time_path_current', $form_state->getValue('login_one_time_path_current'))
      ->set('login_one_time_path_custom', $form_state->getValue('login_one_time_path_custom'))
      ->set('login_one_time_path_default', $form_state->getValue('login_one_time_path_default'))
      ->set('login_one_time_user_view', $form_state->getValue('login_one_time_user_view'))
      ->set('login_one_time_user_select', $form_state->getValue('login_one_time_user_select'))
      ->set('login_one_time_user_set_mail', $form_state->getValue('login_one_time_user_set_mail'))
      ->set('login_one_time_user_ignore_current_pass', $form_state->getValue('login_one_time_user_ignore_current_pass'))
      ->save();
  }
}